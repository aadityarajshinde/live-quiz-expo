-- Update the advance_quiz_phase function to use 30 seconds for questions instead of 40
...
BEGIN
  ...
  IF active_session.phase = 'question' THEN
    -- Move to results phase (10 seconds)
  ...
  ELSIF active_session.phase = 'results' THEN
    ...
    IF next_question IS NOT NULL THEN
      -- Move to next question (30 seconds instead of 40)
      question_end_time := NOW() + INTERVAL '30 seconds';
